...
<a href="<?= get_permalink($item->ID) ?>"
   ...
   data-aos-anchor="center-center">
    ...
    <div class="h-full group-focus-visible:brightness-75 brightness-100 transition duration-300 ease-in-out group-hover:brightness-75">
        <?= get_the_post_thumbnail($item->ID, 'large', array(
                'style' => 'object-position :' . $focus_point,
                'class' => 'overflow-hidden absolute inset-0 object-cover w-full h-full scale-100 transition-transform duration-300 group-hover:scale-110 group-focus-visible:scale-110')) ?>
    </div>
</a>