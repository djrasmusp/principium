        ...
        { ?>
            <section class="<?= $this->get_class_name() ?> mt-8" id="<?= $this->get_id() ?>">
                <div class="px-6 md:px-16 max-w-5xl">
                    ...
                    <h2 class="text-base mb-4 md:text-lg font-header uppercase tracking-widest"><?= $this->get_title() ?></h2>
                    <?php endif; ?>
                    ...
                    ->get_video['title']) ?>">
                        <div
                                class="relative aspect-video w-full overflow-hidden bg-header-bg <?= $this->is_preview ? "" : "group" ?>">
